\documentclass[a4paper,11pt,twoside,a4paper,openright, fleqn]{report}
\usepackage{etex}
...
\definecolor{custom1}{RGB}{180,0,0}
...
\lstdefinestyle{customc}{
  ...
  language=C,
  keywords=[1]{double, long, int, uint, float, char, short},
  keywords=[2]{U32, U8, S8, S32},
  keywords=[3]{static, void, return, break},
  keywords=[4]{for, if, while, do, else},
  keywords=[5]{nxt_motor_get_count, ecrobot_send_i2c, ecrobot_read_i2c, PID, MotorPID, nxt_motor_set_speed, TerminateTask, cock, fire, motor_in_range, systick_wait_ms, resetTowerTo, reset, kalman, matrixMultiply, matrixCopy, matrixScale, matrixAdd, matrixSubtract, TASK},
  keywordstyle=[1]\color{green!40!black},
  keywordstyle=[2]\color{green!40!black},
  keywordstyle=[3]\color{cyan},
  keywordstyle=[4]\color{orange!70!black},
  keywordstyle=[5]\color{custom1},
...
\vspace*{\fill}
\begin{center}
\textit{This page is intentionally left (almost) blank.}\thispagestyle{empty}
\end{center}
\vspace{\fill}}
...
\usepackage{lastpage}% Add the command \pageref{LastPage} which refers to the
...
% Use this conditional to set whether the build is a draft (\DRAFTtrue) or a final (\DRAFTfalse)
% Everything is handled automatically in accordance with this
% Use false for supervisor versions and final version
\newif \ifDRAFT
\DRAFTfalse
...
\input{setup/customcmds.tex}
% Include phrases
%\input{setup/phrases.tex}

% Include DRAFT headers if the document is a draft
\ifDRAFT
    \usepackage{fancyhdr}
    \fancyhf{}
    \fancyhead[C]{\draftlabel}
\fi

% Kommentarer og rettelser med \fxnote. Med 'final' i stedet for 'draft' udloeser hver note en error i den faerdige rapport.
\usepackage[footnote,\ifDRAFT draft\else final\fi,english,silent,nomargin]{fixme}
...
\titlespacing*{\paragraph} {0pt}{3.25ex plus 1ex minus 1.5ex}{-1em}
