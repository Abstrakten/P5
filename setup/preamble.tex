\documentclass[a4paper,14pt,twoside,a4paper,openright, fleqn]{report}
...
\lstset{ %
  ...
  morekeywords={DataViewBinder, DataNotifications},            % if you want to add more keywords to the set
