...
\centering
\begin{tikzpicture}
    \begin{axis}[title=Stationary mode - 1 ultrasonic sensor, xlabel=Time in ms, ylabel=Distance in cm / Rev in degrees (motor), legend cell align=left, ymajorgrids=true, grid style=dashed, width=14cm, height=9cm, domain=0, xmin=0]
