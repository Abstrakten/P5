...
\centering
\begin{tikzpicture}
    \begin{axis}[title=Sweep mode - 2 ultrasonic sensors, xlabel=Time in ms, ylabel=Distance in cm / Rev in degrees (motor), ymajorgrids=true, grid style=dashed,legend cell align=left, width=14cm, height=9cm, domain=0, xmin=0]
