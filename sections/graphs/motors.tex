...
\centering
\begin{tikzpicture}
    \begin{axis}[xlabel=Power level \%, ylabel=RPM, ymajorgrids=true, grid style=dashed, width=14cm, height=9cm, domain=0, legend pos=north west, legend cell align=left, xmin=10, ymin=0]
